        ...
        {items.map((edu, i) => (
          <div key={i} style={{ animationDelay: `${i * 100}ms` }} className="stagger-item flex items-start gap-5 sm:gap-6">
            ...
            <div className="bg-white border rounded-2xl shadow-[0_1px_6px_rgba(0,0,0,.04),0_4px_18px_rgba(0,0,0,.03)]
              ...
              border-l-[2px] border-l-green-400 border-slate-900/7 rounded-tl-sm rounded-bl-sm">
        ...
        {groups.map(g => (
          <div key={g.key}>
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <span className="font-['Tiro_Bangla'] text-[1.05rem] text-slate-900 font-semibold">{g.label}</span>
            </div>
